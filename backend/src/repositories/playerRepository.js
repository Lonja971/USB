...
import { generateComplexToken } from "../utils/player.js";
...
export const PlayerRepository = {
   ...
   async updatePlayerCurrentBattle(playerId, battleData) {
      try {
   ...
   async updateCurrentBattleId(playerId, battleId=null){
      await pool.query(
         `UPDATE players
   ...
   async createPlayerAccount(playerName, password) {
      try {
   ...
   async loginIntoPlayerAccount(playerName, password, playerIp) {
      try {
